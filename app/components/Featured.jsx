...
const Featured = () => {
  return (
    <motion.section
      ...
      className="bg-soft_green-secondary xl:h-[240px] max-w-[1305px] ml-auto xl:-top-[120px] relative rounded-tl-[30px] px-[80px] py-[60px]"
    >
      <div className="flex flex-col xl:flex-row items-center h-full gap-x-[30px] text-center xl:text-left">
        ...
        <p className="flex-1 text-soft_green leading-loose">
          ...
          neque quidem fuga non cumque porro eveniet perspiciatis.
        </p>
      </div>
    </motion.section>
  );
