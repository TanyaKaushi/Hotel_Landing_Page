  ...
  return (
    <footer className="bg-soft_green-secondary relative pt-12 xl:pt-0">
      <div className="container mx-auto">
        ...
        >
          <div className="flex flex-col xl:flex-row bg-white p-8 rounded-xl min-h-[390px] xl:p-20 xl:-translate-y-36 xl:gap-x-12">
            {/* logo and text */}
            <div className="xl:w-[470px] mb-6 xl:mb-0">
              ...
              <p className="text-lg leading-9">
                ...
                nobis sequi doloremque tempore vitae reiciendis neque eveniet
                incidunt voluptatum explicabo?
              </p>
            </div>
